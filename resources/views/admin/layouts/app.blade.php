...
<head>
    ...
    <style>
        ...
        :root {
            ...
            /* Brand Colors (Paralkes+ — biru medis) */
            --brand-50:  #EFF6FF;
            --brand-100: #DBEAFE;
            --brand-500: #1D6FA4;
            --brand-600: #155E8C;
            --brand-700: #0D4B73;
            --accent:    #2E9E6B; /* hijau medis */
...
<div class="layout">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <a href="{{ route('dashboard') }}" class="sidebar-logo">
            <img src="{{ asset('images/logo-paralkes.png') }}" alt="Paralkes+" onerror="this.src='data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 40 40%22><rect width=%2240%22 height=%2240%22 rx=%228%22 fill=%22%231D6FA4%22/><text x=%2250%25%22 y=%2255%25%22 dominant-baseline=%22middle%22 text-anchor=%22middle%22 fill=%22white%22 font-size=%2214%22 font-weight=%22bold%22>P+</text></svg>'">
...
<script>
    ...
    function applyTheme(t) {
        ...
        fetch('/theme', { method: 'POST', headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content }, body: JSON.stringify({ theme: t }) }).catch(()=>{});
    }
