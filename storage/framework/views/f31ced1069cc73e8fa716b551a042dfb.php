...
<head>
    ...
    <title>Invoice Penjualan - <?php echo e($penjualan->nama_pelanggan); ?></title>
    <style>
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="kop">
            <div class="kop-left">
                <img src="<?php echo e(asset('images/logo-cop-paralkesplus2.png')); ?>" alt="Logo Kiri">
            </div>
            ...
            <div class="kop-right">
                <img src="<?php echo e(asset('images/logo-cop-paralkesplus3.png')); ?>" alt="Logo Kanan">
            </div>
        </div>
        ...
        <div class="invoice-title-bar">
            ...
            <span class="status-badge-print <?php echo e($badgeClass); ?>"><?php echo e($badgeLabel); ?></span>
        </div>
        ...
        <div class="info-section">
            ...
            <div class="info-box">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">: INV-JL-<?php echo e(str_pad($penjualan->id, 5, '0', STR_PAD_LEFT)); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Tgl Penjualan</span>
                    <span class="info-value">:
                        <?php echo e($penjualan->tanggal_penjualan
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">: <?php echo e(ucfirst($penjualan->jenis_pembayaran ?? '-')); ?></span>
                </div>
                <div class="info-row">
                    ...
                    <span class="info-value">:
                        ...
                        <?php elseif($statusPembayaran === 'dp'): ?>
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">: <?php echo e($now->translatedFormat('d F Y')); ?></span>
                </div>
            </div>
            ...
            <?php if($jasaPengiriman !== 'ambil_sendiri' || $hargaPengiriman > 0 || $jasaInstalasi > 0): ?>
            <div class="info-box kirim-box">
                <div class="info-title"><?php echo e($kirimIcon); ?> Informasi Pengiriman</div>
                <div class="info-row">
                    <span class="info-label">Jasa Kirim</span>
                    <span class="info-value">: <?php echo e($kirimLabel); ?></span>
                </div>
                <?php if($hargaPengiriman > 0): ?>
                <div class="info-row">
                    <span class="info-label">Ongkos Kirim</span>
                    <span class="info-value" style="color:#1D6FA4;">
                        : Rp <?php echo e(number_format($hargaPengiriman, 0, ',', '.')); ?>
            ...
            <div class="info-box" style="display:flex;flex-direction:column;justify-content:flex-end;max-width:160px;flex:0 0 160px;">
                ...
                <span class="chip-ambil">🚶 <?php echo e($kirimLabel); ?></span>
            </div>
            <?php endif; ?>
        ...
        <table class="detail-table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                ...
                <tr>
                    ...
                    <td class="center">
                        <span class="badge-kondisi-<?php echo e($kondisi); ?>"><?php echo e(ucfirst($kondisi)); ?></span>
                    </td>
                    <td class="center"><?php echo e($qty); ?></td>
                    <td class="center"><?php echo e($item->satuan); ?></td>
                    <td class="right">Rp <?php echo e(number_format($hargaSatuan, 0, ',', '.')); ?></td>
                    <td class="center">
                        <?php if($diskon > 0): ?>
                            <span class="badge-diskon"><?php echo e($diskon); ?>%</span>
                        <?php else: ?>
                            <span style="color:#bbb; font-size:11px;">–</span>
                        <?php endif; ?>
                    </td>
                    <td class="right">Rp <?php echo e(number_format($subtotal, 0, ',', '.')); ?></td>
                </tr>
        ...
        <div class="biaya-section">
            ...
            <div class="terbilang-wrap">
                <table class="terbilang-table">
                    ...
                    <tr>
                        <td class="tb-value"><?php echo e($terbilangTotal); ?></td>
                    </tr>
                    <?php if($terbilangSisa && $sisaTagihan > 0): ?>
                    <tr>
                        <td class="tb-sub">
                            Sisa: <?php echo e($terbilangSisa); ?>
            ...
            <div class="biaya-box">
                <div class="biaya-row">
                    ...
                    <span class="value">Rp <?php echo e(number_format($subtotalBarang, 0, ',', '.')); ?></span>
                </div>

                <?php if($diskonGlobal > 0): ?>
                <div class="biaya-row diskon-row">
                    <span class="label">Diskon</span>
                    <span class="value">– Rp <?php echo e(number_format($diskonGlobal, 0, ',', '.')); ?></span>
                </div>
                <?php endif; ?>
                ...
                <div class="biaya-row ongkir-row">
                    ...
                    <span class="value">+ Rp <?php echo e(number_format($hargaPengiriman, 0, ',', '.')); ?></span>
                </div>
                <?php endif; ?>
                ...
                <div class="biaya-row instalasi-row">
                    ...
                    <span class="value">+ Rp <?php echo e(number_format($jasaInstalasi, 0, ',', '.')); ?></span>
                </div>
                <?php endif; ?>

                <div class="biaya-row total-row">
                    <span class="label">Total Tagihan</span>
                    <span class="value">Rp <?php echo e(number_format($totalTagihan, 0, ',', '.')); ?></span>
                </div>

                <?php if($totalTerbayar > 0): ?>
                <div class="biaya-row dibayar-row">
                    <span class="label">✓ Sudah Dibayar</span>
                    <span class="value">– Rp <?php echo e(number_format($totalTerbayar, 0, ',', '.')); ?></span>
                </div>

                <?php if($sisaTagihan > 0): ?>
                <div class="biaya-row sisa-row-belum">
                    <span class="label">⚠ Sisa Tagihan</span>
                    <span class="value">Rp <?php echo e(number_format($sisaTagihan, 0, ',', '.')); ?></span>
                </div>
                <?php else: ?>
        ...
        <div class="riwayat-section">
            ...
            <table class="riwayat-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $pembayarans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $bayar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="center"><?php echo e($i + 1); ?></td>
                        <td>
                            <?php echo e($bayar->tanggal_bayar
                                ? \Carbon\Carbon::parse($bayar->tanggal_bayar)->translatedFormat('d M Y')
                                : '-'); ?>

                        </td>
                        <td>
                            <span class="badge-tipe tipe-<?php echo e($bayar->tipe ?? 'dp'); ?>">
                                <?php echo e(ucfirst($bayar->tipe ?? '-')); ?>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td class="right">Rp <?php echo e(number_format($totalTerbayar, 0, ',', '.')); ?></td>
                        <td></td>
                    </tr>
                </tfoot>
            </table>
        ...
        <div class="catatan-box">
            ...
            <p><?php echo e($penjualan->keterangan ?: 'Tidak ada catatan tambahan.'); ?></p>
            <?php if($isBatal && $penjualan->catatan_pembatalan): ?>
            <p style="margin-top:6px; color:#b91c1c; font-weight:600;">
                ⚠ Alasan Pembatalan: <?php echo e($penjualan->catatan_pembatalan); ?>
        ...
        <div class="ttd-section">
            ...
            <div class="ttd-logo">
                <img src="<?php echo e(asset('images/logo-paralkes-white.png')); ?>" alt="Logo Paralkes">
            </div>
            <div class="ttd-box">
                <div class="ttd-label">Pelanggan,</div>
                <div class="ttd-name"><?php echo e($penjualan->nama_pelanggan); ?></div>
    ...
    <div class="page-footer">
        ...
        pada <?php echo e($now->translatedFormat('d F Y, H:i')); ?> WIB<br>
...
</html><?php /**PATH C:\laragon\www\paralkesplus\resources\views/admin/penjualan/cetak/invoice.blade.php ENDPATH**/ ?>