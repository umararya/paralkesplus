...
<?php $__env->startSection('breadcrumb', 'Inventory'); ?>
...
<div class="summary-grid">
    <div class="summary-card blue">
        ...
        <div class="summary-value"><?php echo e($summary['total_item']); ?></div>
    </div>
    <div class="summary-card green">
        <div class="summary-label">Stok Tersedia</div>
        <div class="summary-value"><?php echo e($summary['total_tersedia']); ?></div>
    </div>
    <div class="summary-card orange">
        <div class="summary-label">Sedang Disewa</div>
        <div class="summary-value"><?php echo e($summary['total_disewa']); ?></div>
    </div>
    <div class="summary-card purple">
        <div class="summary-label">Stok Bekas</div>
        <div class="summary-value"><?php echo e($summary['total_bekas']); ?></div>
    </div>
</div>
...
<div class="table-card">
    ...
    <div class="table-toolbar">
        <div class="toolbar-left">
            ...
            <form method="GET" action="<?php echo e(route('inventory.index')); ?>" id="perPageForm">
            ...
            <form method="GET" action="<?php echo e(route('inventory.index')); ?>" class="search-form">
                ...
                <?php if($search): ?>
                <a href="<?php echo e(route('inventory.index', ['per_page' => $perPage])); ?>" class="btn btn-reset">
    ...
    <div class="info-bar">
        <div class="info-bar-text">
            <?php if($search): ?>
                ...
                &nbsp;<span class="badge-count"><?php echo e($inventories->total()); ?> data</span>
            <?php else: ?>
                <i class="ri-archive-drawer-line"></i>
                Total <span class="badge-count"><?php echo e($inventories->total()); ?> item</span>
            <?php endif; ?>
        </div>
        <?php if($inventories->total() > 0): ?>
        <div class="info-bar-text">
            Halaman <strong><?php echo e($inventories->currentPage()); ?></strong> dari <strong><?php echo e($inventories->lastPage()); ?></strong>
        </div>
        <?php endif; ?>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    <td style="color:var(--text-muted); font-size:12.5px; font-weight:500;">
                        <?php echo e($inventories->firstItem() + $loop->index); ?>
                    ...
                    <td style="color:var(--text-muted);"><?php echo e($item->kategori ?? '—'); ?></td>
                    <td class="center">
                        <span class="stok-badge <?php echo e($item->stok_tersedia > 0 ? 'stok-ada' : 'stok-habis'); ?>">
                            <?php echo e($item->stok_tersedia); ?>

                        </span>
                    </td>
                    <td class="center">
                        <span class="stok-badge <?php echo e($item->stok_disewa > 0 ? 'stok-disewa' : ''); ?>"
                              style="<?php echo e($item->stok_disewa == 0 ? 'color:var(--text-muted);' : ''); ?>">
                            <?php echo e($item->stok_disewa); ?>

                        </span>
                    </td>
                    <td class="center">
                        <span class="stok-badge stok-baru"><?php echo e($item->stok_baru); ?></span>
                    </td>
                    <td class="center">
                        <span class="stok-badge stok-bekas"><?php echo e($item->stok_bekas); ?></span>
                    </td>
                    ...
                    <td class="center">
                        <div class="aksi-wrap">
                            <button class="btn-aksi" type="button"
                                    onclick="toggleDropdown(event, 'dd-<?php echo e($item->id); ?>')"
                                    title="Aksi">
                                &#8942;
                            </button>
                            <div class="dropdown-menu" id="dd-<?php echo e($item->id); ?>">
                                <a href="<?php echo e(route('inventory.show', $item->id)); ?>" class="dropdown-item">
                                    <i class="ri-eye-line" style="color:#3B82F6;"></i> Detail
                                </a>
                                <a href="<?php echo e(route('inventory.edit', $item->id)); ?>" class="dropdown-item">
                                    <i class="ri-edit-line" style="color:var(--brand-500);"></i> Edit Data
                                </a>
                                <div class="dropdown-divider"></div>
                                <button type="button" class="dropdown-item danger"
                                        onclick="openDeleteModal(<?php echo e($item->id); ?>, '<?php echo e(addslashes($item->nama_produk)); ?>')">
                                    <i class="ri-delete-bin-line"></i> Hapus
                                </button>
                                <form id="formHapus-<?php echo e($item->id); ?>"
                                      action="<?php echo e(route('inventory.destroy', $item->id)); ?>"
                ...
                <tr>
                    <td colspan="8">
                        <div class="empty-state">
                            <i class="ri-archive-drawer-line"></i>
                            <h3><?php echo e($search ? 'Tidak ditemukan' : 'Inventory masih kosong'); ?></h3>
                            <p><?php echo e($search ? 'Coba kata kunci lain atau klik Reset.' : 'Tambah data manual atau data otomatis masuk dari transaksi pembelian.'); ?></p>
                        </div>
                    </td>
                </tr>
                <?php endif; ?>
    ...
    <div class="table-footer">
        <div class="pagination-meta">
            Menampilkan
            <strong><?php echo e($inventories->firstItem()); ?> – <?php echo e($inventories->lastItem()); ?></strong>
            dari <strong><?php echo e($inventories->total()); ?></strong> data
        </div>

        <?php if($inventories->hasPages()): ?>
        <nav class="pagination-nav">
            <?php if($inventories->onFirstPage()): ?>
                <span class="page-btn disabled"><i class="ri-arrow-left-s-line"></i></span>
            <?php else: ?>
                <a class="page-btn" href="<?php echo e($inventories->previousPageUrl()); ?>"><i class="ri-arrow-left-s-line"></i></a>
            <?php endif; ?>
            ...
            <?php $__currentLoopData = $rendered; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($pg === '...'): ?>
                    <span class="page-ellipsis">…</span>
                <?php elseif($pg == $current): ?>
                    <span class="page-btn active"><?php echo e($pg); ?></span>
                <?php else: ?>
                    <a class="page-btn" href="<?php echo e($inventories->url($pg)); ?>"><?php echo e($pg); ?></a>
                <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

            <?php if($inventories->hasMorePages()): ?>
                <a class="page-btn" href="<?php echo e($inventories->nextPageUrl()); ?>"><i class="ri-arrow-right-s-line"></i></a>
            <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\paralkesplus\resources\views/admin/inventory/index.blade.php ENDPATH**/ ?>