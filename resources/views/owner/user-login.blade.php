...
<div class="table-card">
    ...
    <div class="table-toolbar">
        ...
        <div class="toolbar-left">
            ...
            {{-- Per-page selector — langsung submit saat berubah --}}
            <form method="GET" action="{{ route('owner.user-login') }}" id="perPageForm">
            ...
            <form method="GET" action="{{ route('owner.user-login') }}" class="search-form" id="searchForm">
                ...
                @if($search)
                <a href="{{ route('owner.user-login', ['per_page' => $perPage]) }}" class="btn btn-reset">
    ...
    <div class="info-bar">
        <div class="info-bar-text">
            @if($search)
                ...
                &nbsp;<span class="badge-count">{{ $users->total() }} pengguna</span>
            @else
                <i class="ri-group-line"></i>
                Total <span class="badge-count">{{ $users->total() }} pengguna</span>
            @endif
        </div>
        @if($users->total() > 0)
        <div class="info-bar-text">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span class="role-badge {{ $roleClass }}">
                            <i class="{{ $roleIcon }}" style="font-size:11px;"></i>
                            {{ ucfirst($user->role) }}
                        </span>
                    </td>
                ...
                <tr>
                    <td colspan="6">
                        <div class="empty-state">
                            ...
                            <p>{{ $search ? 'Coba kata kunci lain atau klik Reset.' : 'Klik "Input Data" untuk menambah pengguna.' }}</p>
                        </div>
                    </td>
                </tr>
                @endforelse
    ...
    <div class="table-footer">
        ...
        <nav class="pagination-nav" aria-label="Pagination">
            ...
            @else
                <a class="page-btn" href="{{ $users->previousPageUrl() }}" title="Halaman sebelumnya">
                    <i class="ri-arrow-left-s-line"></i>
                </a>
            @endif
            ...
            @if($users->hasMorePages())
                <a class="page-btn" href="{{ $users->nextPageUrl() }}" title="Halaman selanjutnya">
...
<div class="modal-overlay" id="modalTambah">
    <div class="modal">
        ...
        <form action="{{ route('owner.user-login.store') }}" method="POST">
            @csrf
            {{-- Pertahankan state pencarian & per_page setelah submit --}}
