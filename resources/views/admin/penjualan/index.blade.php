...
<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:24px;">
    <div>
        <h1 style="font-size:20px; font-weight:700; color:var(--text-primary); margin-bottom:4px;">Manajemen Penjualan</h1>
        <p style="font-size:13px; color:var(--text-muted);">Kelola data transaksi penjualan alat kesehatan</p>
    </div>
        ...
        <table style="width:100%; border-collapse:collapse; font-size:13.5px;">
            <thead>
                <tr style="border-bottom:2px solid var(--border);">
                    ...
                    <th style="padding:12px 16px; text-align:left; font-weight:600; color:var(--text-secondary);">Nama Pembeli</th>
                    <th style="padding:12px 16px; text-align:left; font-weight:600; color:var(--text-secondary);">Produk</th>
            ...
            <tbody>
                <tr>
                    <td colspan="8" style="padding:48px 16px; text-align:center; color:var(--text-muted);">
                        <i class="ri-exchange-dollar-line" style="font-size:36px; display:block; margin-bottom:8px; opacity:0.4;"></i>
