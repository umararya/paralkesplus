...
<div style="display:flex; align-items:center; gap:12px; margin-bottom:24px;">
    ...
    <div>
        ...
        <p style="font-size:13px; color:var(--text-muted);">Isi form berikut untuk mencatat transaksi penjualan baru</p>
    </div>
</div>
        ...
        <div style="display:grid; gap:20px;">
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                ...
                <div>
                    ...
                    <input type="number" name="harga_jual" value="{{ old('harga_jual') }}" min="0"
                           placeholder="0"
                           style="width:100%; padding:10px 14px; border:1px solid var(--border);
                                  border-radius:8px; font-size:13.5px; background:var(--bg-primary);
                                  color:var(--text-primary); outline:none; transition:border-color 0.2s;"
