...
<head>
    ...
    <title>Invoice Penyewaan - <?php echo e($penyewaan->nama_penyewa); ?></title>
    <style>
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="info-section">
            <div class="info-box">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">: INV-<?php echo e(str_pad($penyewaan->id, 5, '0', STR_PAD_LEFT)); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Tgl Mulai Sewa</span>
                    <span class="info-value">:
                        <?php echo e($penyewaan->tgl_mulai
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">:
                        <?php echo e($penyewaan->tgl_selesai
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">: <?php echo e($penyewaan->durasi_hari); ?> Hari</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Metode Bayar</span>
                    <span class="info-value">: <?php echo e(ucfirst($penyewaan->metode_pembayaran)); ?></span>
                </div>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">: <?php echo e($penyewaan->nama_penyewa); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">No. Telepon</span>
                    <span class="info-value">: <?php echo e($penyewaan->nomor_telepon); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Alamat</span>
                    <span class="info-value">: <?php echo e($penyewaan->alamat_penyewa); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Metode Pengiriman</span>
                    <span class="info-value">: <?php echo e($penyewaan->pengiriman_label ?? $penyewaan->pengiriman); ?></span>
                </div>
            </div>
        </div>
        ...
        <table class="detail-table">
            ...
            <tbody>
                <?php $__currentLoopData = $legacyList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="center"><?php echo e($i + 1); ?></td>
                    <td><?php echo e($produk); ?></td>
                    <?php if($i === 0): ?>
                    <td class="center" rowspan="<?php echo e(count($legacyList)); ?>">
                        <?php echo e($penyewaan->tgl_mulai ? $penyewaan->tgl_mulai->locale('id')->translatedFormat('d F Y') : '-'); ?>

                    </td>
                    <td class="center" rowspan="<?php echo e(count($legacyList)); ?>">
                        <?php echo e($penyewaan->tgl_selesai ? $penyewaan->tgl_selesai->locale('id')->translatedFormat('d F Y') : '-'); ?>

                    </td>
                    <td class="center" rowspan="<?php echo e(count($legacyList)); ?>"><?php echo e($penyewaan->durasi_hari); ?> Hari</td>
                    <?php endif; ?>
                </tr>
        ...
        <div class="biaya-section">
            ...
            <div class="terbilang-wrap">
                <table class="terbilang-table">
                    ...
                    <tr><td class="tb-value"><?php echo e($terbilangStr); ?></td></tr>
                </table>
            </div>
            ...
            <div class="biaya-box">
                <?php if($useDetail): ?>
                    <div class="biaya-row">
                        ...
                        <span class="value">Rp <?php echo e(number_format($subtotalSewa, 0, ',', '.')); ?></span>
                    </div>
                ...
                <div class="biaya-row">
                    ...
                    <span class="value">
                        <?php echo e($biayaOngkir > 0 ? 'Rp ' . number_format($biayaOngkir, 0, ',', '.') : 'Gratis'); ?>
        ...
        <div class="catatan-box">
            ...
            <p><?php echo e($penyewaan->keterangan ?: 'Tidak ada catatan tambahan.'); ?></p>
        ...
        <div class="ttd-section">
            ...
            <div class="ttd-box">
                ...
                <div class="ttd-name"><?php echo e($penyewaan->nama_penyewa); ?></div>
...
</html><?php /**PATH C:\laragon\www\paralkesplus\resources\views/admin/penyewaan/cetak/invoice.blade.php ENDPATH**/ ?>