<?php $__env->startSection('title', 'Tambah Penyewaan'); ?>
<?php $__env->startSection('breadcrumb', 'Tambah Penyewaan'); ?>
...
<div class="form-card">
    <form action="<?php echo e(route('penyewaan.store')); ?>" method="POST" enctype="multipart/form-data" id="form-penyewaan">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-section">
            ...
            <div class="form-grid form-grid-2">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_penyewa" value="<?php echo e(old('nama_penyewa')); ?>"
                           placeholder="Nama lengkap penyewa"
                           class="form-control <?php echo e($errors->has('nama_penyewa') ? 'is-invalid' : ''); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="nomor_telepon" value="<?php echo e(old('nomor_telepon')); ?>"
                           ...
                           class="form-control <?php echo e($errors->has('nomor_telepon') ? 'is-invalid' : ''); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="tempat_tanggal_lahir" value="<?php echo e(old('tempat_tanggal_lahir')); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nomor_ktp" value="<?php echo e(old('nomor_ktp')); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group" style="grid-column:1/-1;">
                    ...
                    <textarea name="alamat_penyewa" rows="3" placeholder="Alamat lengkap penyewa"
                              ...
                              required><?php echo e(old('alamat_penyewa')); ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="date-range-wrap">
                        <input type="text" id="tgl_mulai" name="tgl_mulai"
                               value="<?php echo e(old('tgl_mulai')); ?>" placeholder="Tanggal Mulai"
                        ...
                        <input type="text" id="tgl_selesai" name="tgl_selesai"
                               value="<?php echo e(old('tgl_selesai')); ?>" placeholder="Tanggal Selesai"
                               class="form-control <?php echo e($errors->has('tgl_selesai') ? 'is-invalid' : ''); ?>"
                               autocomplete="off" readonly required>
                    </div>
                    <input type="hidden" id="durasi_hari" name="durasi_hari" value="<?php echo e(old('durasi_hari')); ?>">
                    <div class="durasi-display" id="durasi-display">
                        <?php if(old('durasi_hari')): ?>
                            <i class="ri-calendar-check-line"></i> <?php echo e(old('durasi_hari')); ?> hari
                        <?php endif; ?>
                    </div>
                ...
                <div class="form-grid form-grid-2" style="grid-column:1/-1;">
                    ...
                    <div class="form-group">
                        ...
                        <select name="pengiriman" id="pengiriman"
                            ...
                            <option value="" disabled <?php echo e(old('pengiriman') ? '' : 'selected'); ?>>-- Pilih metode pengiriman --</option>
                            <option value="mandiri" <?php echo e(old('pengiriman')=='mandiri'?'selected':''); ?>>Ambil dan Antar kembali sendiri oleh Penyewa</option>
                            <option value="Gosend / GrabExpress" <?php echo e(old('pengiriman')=='Gosend / GrabExpress'?'selected':''); ?>>via Gosend / GrabExpress</option>
                            <option value="Rental Mobil Paralkes" <?php echo e(old('pengiriman')=='Rental Mobil Paralkes'?'selected':''); ?>>via Rental Mobil Paralkes</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="biaya_ongkir" id="biaya_ongkir"
                               value="<?php echo e(old('biaya_ongkir', 0)); ?>" min="0" placeholder="0"
            ...
            <div class="form-grid form-grid-2">
                ...
                <div class="form-group">
                    ...
                    <select name="metode_pembayaran" id="metode_pembayaran"
                        ...
                        <option value="" disabled <?php echo e(old('metode_pembayaran') ? '' : 'selected'); ?>>-- Pilih metode --</option>
                        <option value="tunai"    <?php echo e(old('metode_pembayaran')=='tunai'   ?'selected':''); ?>>Tunai / Cash</option>
                        <option value="transfer" <?php echo e(old('metode_pembayaran')=='transfer'?'selected':''); ?>>Transfer via Bank BCA</option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="diskon_global" id="diskon_global"
                           value="<?php echo e(old('diskon_global', 0)); ?>" min="0" placeholder="0"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="bukti_pembayaran" value="<?php echo e(old('bukti_pembayaran')); ?>"
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <textarea name="keterangan" rows="3"
                          ...
                          class="form-control <?php echo e($errors->has('keterangan') ? 'is-invalid' : ''); ?>"><?php echo e(old('keterangan')); ?></textarea>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if ('<?php echo e(old("pengiriman")); ?>') updatePengirimanNote();
    if ('<?php echo e(old("metode_pembayaran")); ?>') updateMetodeInfo();
});
</script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\paralkesplus\resources\views/admin/penyewaan/create.blade.php ENDPATH**/ ?>