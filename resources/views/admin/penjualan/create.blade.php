...
<div class="form-card">
    <form action="{{ route('penjualan.store') }}" method="POST" enctype="multipart/form-data" id="form-penjualan">
        @csrf
        ...
        <div class="form-section">
            ...
            <div class="form-grid form-grid-2">
                ...
                <div class="form-group">
                    <label class="form-label">Foto Bukti Pembayaran <span class="hint">(jpg/png, maks 2MB)</span></label>
...
function addRow(data = {}) {
    ...
    const satuanOpts = ['unit','pcs','set','buah','pasang','botol','box']
