...
<?php $__env->startSection('breadcrumb', 'Tambah Penjualan'); ?>
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama_pelanggan"
                       class="form-control <?php echo e($errors->has('nama_pelanggan') ? 'is-invalid' : ''); ?>"
...
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><i class="ri-error-warning-line"></i> <?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="nomor_telepon" class="form-control"
                       value="<?php echo e(old('nomor_telepon')); ?>" placeholder="08xx-xxxx-xxxx">
            </div>

            <div class="form-group full">
                <label class="form-label">Alamat Pelanggan <span class="req">*</span></label>
                <textarea name="alamat_pelanggan"
                          class="form-control <?php echo e($errors->has('alamat_pelanggan') ? 'is-invalid' : ''); ?>"
                          placeholder="Alamat lengkap pelanggan" required><?php echo e(old('alamat_pelanggan')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="date" name="tanggal_penjualan"
                       class="form-control <?php echo e($errors->has('tanggal_penjualan') ? 'is-invalid' : ''); ?>"
                       value="<?php echo e(old('tanggal_penjualan', date('Y-m-d'))); ?>" required>
                <?php $__errorArgs = ['tanggal_penjualan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><i class="ri-error-warning-line"></i> <?php echo e($message); ?></div><?php unset($message);
        ...
        <div class="form-grid">
            ...
            <div class="form-group full">
                ...
                <select name="jasa_pengiriman" id="jasa_pengiriman"
                        class="form-control <?php echo e($errors->has('jasa_pengiriman') ? 'is-invalid' : ''); ?>"
                        onchange="onKirimChange(this.value)" required>
                    <option value="ambil_sendiri"
                        <?php echo e(old('jasa_pengiriman', 'ambil_sendiri') === 'ambil_sendiri' ? 'selected' : ''); ?>>
                        🚶 Ambil dan antar kembali oleh penyewa
                    </option>
                    <option value="gosend_grab"
                        <?php echo e(old('jasa_pengiriman') === 'gosend_grab' ? 'selected' : ''); ?>>
                        🛵 Via GoSend / GrabExpress
                    </option>
                    <option value="rental_mobil"
                        <?php echo e(old('jasa_pengiriman') === 'rental_mobil' ? 'selected' : ''); ?>>
                        🚗 Via Rental Mobil Paralkes
                    </option>
                </select>
                <?php $__errorArgs = ['jasa_pengiriman'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><i class="ri-error-warning-line"></i> <?php echo e($message); ?></div><?php unset($message);
            ...
            <div class="form-group" id="wrap-harga-pengiriman">
                ...
                <div class="input-prefix-wrap">
                    ...
                    <input type="number" name="harga_pengiriman" id="harga_pengiriman"
                           class="form-control"
                           value="<?php echo e(old('harga_pengiriman', 0)); ?>"
                           min="0" placeholder="0"
                           oninput="recalcTotal()">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="input-prefix-wrap">
                    ...
                    <input type="number" name="jasa_instalasi" id="jasa_instalasi"
                           class="form-control"
                           value="<?php echo e(old('jasa_instalasi', 0)); ?>"
        ...
        <div style="display:flex;justify-content:flex-end;margin-top:12px;align-items:center;gap:10px;">
            ...
            <div class="input-prefix-wrap" style="width:200px;">
                ...
                <input type="number" name="diskon_global" id="diskon_global"
                       class="form-control" value="<?php echo e(old('diskon_global', 0)); ?>"
                       min="0" placeholder="0"
                       oninput="recalcTotal()">
            </div>
        </div>
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <select name="metode_pembayaran" id="metode_pembayaran"
                    ...
                    <option value="cash"     <?php echo e(old('metode_pembayaran','cash') === 'cash'     ? 'selected' : ''); ?>>💵 Cash — Lunas Langsung</option>
                    <option value="dp"       <?php echo e(old('metode_pembayaran')        === 'dp'       ? 'selected' : ''); ?>>📋 DP — Down Payment</option>
                    <option value="transfer" <?php echo e(old('metode_pembayaran')        === 'transfer' ? 'selected' : ''); ?>>🏦 Transfer — Lunas Langsung</option>
                </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <select name="metode_bayar_awal" id="metode_bayar_awal"
                        class="form-control <?php echo e($errors->has('metode_bayar_awal') ? 'is-invalid' : ''); ?>" required>
                    <option value="cash"     <?php echo e(old('metode_bayar_awal','cash') === 'cash'     ? 'selected' : ''); ?>>Cash</option>
                    <option value="transfer" <?php echo e(old('metode_bayar_awal')        === 'transfer' ? 'selected' : ''); ?>>Transfer Bank</option>
                    <option value="qris"     <?php echo e(old('metode_bayar_awal')        === 'qris'     ? 'selected' : ''); ?>>QRIS</option>
                </select>
                <?php $__errorArgs = ['metode_bayar_awal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><i class="ri-error-warning-line"></i> <?php echo e($message); ?></div><?php unset($message);
            ...
            <div class="form-group">
                ...
                <div class="input-prefix-wrap">
                    ...
                    <input type="number" name="jumlah_bayar_awal" id="jumlah_bayar_awal"
                           class="form-control <?php echo e($errors->has('jumlah_bayar_awal') ? 'is-invalid' : ''); ?>"
                           value="<?php echo e(old('jumlah_bayar_awal', 0)); ?>"
                           min="0" placeholder="0" required>
                </div>
                <?php $__errorArgs = ['jumlah_bayar_awal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><i class="ri-error-warning-line"></i> <?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="date" name="tanggal_bayar_awal"
                       class="form-control <?php echo e($errors->has('tanggal_bayar_awal') ? 'is-invalid' : ''); ?>"
                       value="<?php echo e(old('tanggal_bayar_awal', date('Y-m-d'))); ?>" required>
                <?php $__errorArgs = ['tanggal_bayar_awal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><i class="ri-error-warning-line"></i> <?php echo e($message); ?></div><?php unset($message);
...
<div style="display:flex;align-items:center;justify-content:flex-end;gap:10px;margin-bottom:24px;">
    <a href="<?php echo e(route('penjualan.index')); ?>" class="btn btn-ghost">
...
function onKirimChange(val) {
    ...
    // Auto-set ongkir = 0 jika ambil sendiri + disable input
    if (cfg.freeOngkir) {
        ongkirInput.value    = 0;
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Init pengiriman — trigger preview badge
    onKirimChange(document.getElementById('jasa_pengiriman').value);

    // Restore old items jika ada error validasi
    <?php if(old('items')): ?>
        <?php $__currentLoopData = old('items'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $oldItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            addRow({
                ...
                nama_barang:  '<?php echo e(addslashes($oldItem["nama_barang"] ?? "")); ?>',
                ...
                diskon:       <?php echo e($oldItem['diskon'] ?? 0); ?>,
            });
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\paralkesplus\resources\views/admin/penjualan/create.blade.php ENDPATH**/ ?>